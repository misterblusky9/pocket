...
@Pseudo
@Mixin(targets = {
        "dev.silvergold.simulatedcoasters.client.cart.CoasterCartEditOutlineClient",
        "dev.silvergold.simulatedcoasters.client.cart.CoasterCartChainLinkOutlineClient"
}, remap = false)
public abstract class CoasterCartModeOutlineScaleMixin {
    @WrapOperation(
            method = "drawCartOutline",
            at = @At(
                    value = "INVOKE",
